 ...
 * Direct link, no pre-filled text (quick contact).
 */
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-5 z-50 flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-heading font-semibold text-[0.78rem] tracking-wide pl-4 pr-5 py-3 rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.45)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.60)] transition-all hover:-translate-y-0.5"
    >
